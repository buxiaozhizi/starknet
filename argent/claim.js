...
(async () => {
    ...
    week_ids = [
        ...
        // 'cb60cc3c-b64b-4314-90ac-0273c1144597',//第五周
        // '9bbbf575-41f8-4e8b-a5de-71aa8f764a6d',//第六周
        // '0ff09ffa-021e-4c73-89d3-15f6dbbecfbe',//第七周
        // 'a13cc197-c5ba-49f7-9812-ab73ae884f5f',//第八周
    ];

    //待领取NFT的钱包账号，钱包账号格式见wallets.json中示例说明
    const wallets = json2Obj(fs.readFileSync(`${__dirname}/wallets.json`).toString());

    const claim_json_path = `${__dirname}/claim.json`;
